...
import coen.cloud.computing.newsfeed.helper.NyArticleMapper;
...
public class NyTimesApiClient {
  ...
  public List<Article> getArticlesForTopic(String topicName) {
    ...
    responseEntity.getBody().getResponse().getDocs().forEach(a -> result.add(NyArticleMapper.mapToArticle(a)));
